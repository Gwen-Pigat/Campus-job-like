...
<nav class="lateral">
 ...
 <?php echo "<img src=../img/ProfilPicture/img-profil-$row[id]-$row[Email].jpg style='width: 75px'>"; ?><br><br>
  </div>
	<ul class="nav nav-stacked span-hide">
		...
		<?php echo "<a href='offre_submit.php?liste_etudiant=$row[Entreprise]'>" ?><li class="student"><i class="fa fa-pencil-square-o fa-3x"></i> <span class="lateral-aside">Liste des étudiants</span></li></a>
