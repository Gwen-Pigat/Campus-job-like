...
?>
	...
	<ul class="nav nav-stacked span-hide">
		<?php echo "<a href='student.php?maj_profil=$random&$row[id_crypt]&$_SESSION[email_e]'><li><i class='fa fa-user fa-3x'></i> <span class='lateral-aside'>Mon profil</span></li></a>"; ?>
